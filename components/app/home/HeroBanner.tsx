...
function CardInner({
  ...
  return (
    <div className="flex flex-col gap-3">
      <span className="flex size-10 shrink-0 items-center justify-center rounded-xl bg-black">
        <CloseGuardLogo className="h-6 w-auto text-[#72fa91]" />
      </span>
      <div>
        <div className="flex items-center gap-2">
          <span className="text-[#72fa91]">{icon}</span>
...
export default function HeroBanner() {
  return (
    <div className="relative overflow-hidden rounded-2xl bg-[#0b140b] p-7 shadow-sm md:h-[300px]">
      ...
      {/* left scrim for text readability over the PixelBlast */}
      <div
      ...
      <div className="relative z-10 flex max-w-md flex-col items-start text-left md:h-full md:justify-center">
        <p className="text-xs font-medium uppercase tracking-widest text-[#72fa91]">
          Démo
        </p>
